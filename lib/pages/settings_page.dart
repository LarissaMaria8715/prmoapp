...
class SettingsPage extends StatelessWidget {
  ...
  _buildTextField({required String label, required String hint}) {
    return Padding(
      ...
      child: TextField(
        ...
        style: GoogleFonts.lato(color: AppColors.darkGray3),
      ),
    );
  }
      ...
      child: Row(
        children: [
          CircleAvatar(
            ...
            child: Icon(Icons.person, size: 40, color: AppColors.darkGray1),
          ),
          ...
          Expanded(
            child: Text(
              ...
              style: GoogleFonts.lato(
                fontSize: 16,
                color: AppColors.darkPurple3,
                fontWeight: FontWeight.w600,
              ),
            ),
          ),
          IconButton(
            icon: const Icon(Icons.edit, color: AppColors.darkPurple3),
            onPressed: () {},
          ),
        ],
      ),
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          backgroundColor: color ?? AppColors.darkPurple3,
  ...
  _buildSwitchSetting({
    ...
    return SwitchListTile(
      activeColor: AppColors.darkPurple3,
      contentPadding: EdgeInsets.zero,
      title: Text(title, style: GoogleFonts.lato(fontSize: 16, color: AppColors.darkGray3)),
      value: value,
      onChanged: (_) {},
    );
  }
        ...
        child: DropdownButtonHideUnderline(
          child: DropdownButton<String>(
            ...
            items: options
              ...
              value: opt,
              child: Text(opt, style: GoogleFonts.lato(color: AppColors.darkGray3)),
            ))
                .toList(),
            onChanged: (val) {},
          ),
  ...
  _buildSettingItem({
    ...
    return ListTile(
      ...
      leading: Icon(icon, color: AppColors.darkPurple3, size: 32),
      title: Text(
        title,
        style: GoogleFonts.lato(
          fontSize: 18,
      ...
      subtitle: Padding(
        ...
        child: Text(
          description,
          style: GoogleFonts.lato(fontSize: 14, color: AppColors.darkGray3),
        ),
      ),
      onTap: onTap,
    );
  ...
  _divider() {
    return Divider(height: 1, thickness: 1, color: AppColors.lightGray3);
  }
}
